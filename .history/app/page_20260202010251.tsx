    ...
    <main className="min-h-screen bg-white text-black">
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <header className="mb-12">
          <h1 className="text-4xl md:text-5xl font-semibold tracking-tight">The Epstein Files</h1>
          <p className="mt-4 text-lg text-gray-600">
            Making complex documents readable, searchable, and understandable — one release at a
            time.
          </p>
        </header>
