    ...
    <main className="min-h-screen bg-white text-black">
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <section>
          ...
          <p>
            Solana Wallet Address:<span>FKjtSKgp5vngiTjr3TR9ouRSNix7qHDjVmn79Zm2h34a</span>{' '}
          </p>
          <p>
            Ethereum Wallet Address:<span>FKjtSKgp5vngiTjr3TR9ouRSNix7qHDjVmn79Zm2h34a</span>{' '}
          </p>
        </section>
